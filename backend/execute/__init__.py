...
class JavaTestExecutor:
    ...
    def run_java_tests_async(self, execution_id):
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                import re
                class_match = re.search(r'class\s+(\w+)', self.test_code)
                ...
                if self.api_code.strip():
                    # Analyser et encapsuler correctement le code utilisateur
                    user_code_wrapped = java_utils.wrap_user_code_in_controller(self.api_code)
                ...
                endpoints_count = java_utils.count_endpoints_in_api(self.api_code)
    ...
    def get_thread(self)->threading.Thread:
        ...
        thread = threading.Thread(
            target=self.run_java_tests_async,
